...
{
	public class OpponentInTheBackCondition : AbsCondition
	{
		public bool reverse;

		public OpponentInTheBackCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
