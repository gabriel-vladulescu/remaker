...
{
	public class TargetRuneTowardCondition : AbsCondition
	{
		public bool reverse;

		public TargetRuneTowardCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
		...
		private bool IsTargetRunToward()
		{
			return false;
		}
	}
