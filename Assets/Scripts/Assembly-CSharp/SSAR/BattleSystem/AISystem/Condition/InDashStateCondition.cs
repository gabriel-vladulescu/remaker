...
{
	public class InDashStateCondition : AbsCondition
	{
		public bool reverse;

		public InDashStateCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
