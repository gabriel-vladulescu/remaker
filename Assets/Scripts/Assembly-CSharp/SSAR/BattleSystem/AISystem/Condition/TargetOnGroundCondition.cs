...
{
	public class TargetOnGroundCondition : AbsCondition
	{
		public TargetOnGroundCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
