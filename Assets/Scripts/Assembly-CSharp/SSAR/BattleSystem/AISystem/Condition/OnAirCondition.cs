...
{
	public class OnAirCondition : AbsCondition
	{
		public bool reverse;

		public OnAirCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
