...
{
	public class DangerousAreaBeforeCondition : AbsCondition
	{
		public bool reverse;

		private DangerousArea dangerousArea;

		public DangerousAreaBeforeCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
