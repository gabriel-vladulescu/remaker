...
{
	public class TargetRunAwayCondition : AbsCondition
	{
		public bool reverse;

		public TargetRunAwayCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
