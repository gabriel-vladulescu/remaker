...
{
	public class OnChangeToArcaneFormCondition : AbsCondition
	{
		private bool flag;

		public OnChangeToArcaneFormCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
