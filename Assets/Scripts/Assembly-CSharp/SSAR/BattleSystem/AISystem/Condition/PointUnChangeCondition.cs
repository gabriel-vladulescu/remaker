...
{
	public class PointUnChangeCondition : AbsCondition
	{
		public bool flag;
		...
		public PointUnChangeCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
