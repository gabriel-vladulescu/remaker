...
{
	public class FinishAllDanagerousAreaCondition : AbsCondition
	{
		public bool flag;

		private DangerousArea dangerousArea;

		public FinishAllDanagerousAreaCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
