...
{
	public class OnBackToNormalFormCondition : AbsCondition
	{
		private bool flag;

		public OnBackToNormalFormCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
