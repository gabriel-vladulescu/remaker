...
{
	public class TargetIsInputAttackCondition : AbsCondition
	{
		public bool reverse;

		public TargetIsInputAttackCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
