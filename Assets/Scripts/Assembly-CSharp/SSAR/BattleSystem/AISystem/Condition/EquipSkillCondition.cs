...
{
	public class EquipSkillCondition : AbsCondition
	{
		public bool reverse;

		public string skillId;

		public EquipSkillCondition(AbsAction absAction, NewMonsterAIComponent newMonsterAiComponent, ConditionConfig conditionConfig)
			: base(null, null, null)
		{
		}
