...
{
	public class ChallengeSacrificeModifier : Modifier
	{
		public class Info
		{
			private readonly float atkBonus;

			private readonly float maxHpReduction;

			private readonly float duration;

			public float AtkBonus => 0f;

			public float MaxHpReduction => 0f;

			public float Duration => 0f;

			public Info(float atkBonus, float maxHpReduction, float duration)
			{
			}
		}
		...
		public ChallengeSacrificeModifier(Info info, Entity target)
		{
		}
