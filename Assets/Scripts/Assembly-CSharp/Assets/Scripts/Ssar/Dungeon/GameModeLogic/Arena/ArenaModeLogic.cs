...
{
	public class ArenaModeLogic : IBattleModeLogic
	{
		private ArenaEnvironmentAssetsPath arenaEnvironmentAssetsPath;

		private DefaultEquippedEquipmentVisualInfo defaultEquippedEquipmentVisualInfo;

		private OnDuelArenaWinLogic duelArenaWinLogic;

		private OnDuelArenaLoseLogic duelArenaLoseLogic;

		private ArenaModeBattleInterfaceLogic arenaModeBattleInterfaceLogic;

		private ArenaDungeonInfo arenaDungeonInfo;

		private Stage stage;

		public ArenaModeParameter Parameter;

		public ArenaModeLogic(ArenaModeParameter parameter)
		{
		}
