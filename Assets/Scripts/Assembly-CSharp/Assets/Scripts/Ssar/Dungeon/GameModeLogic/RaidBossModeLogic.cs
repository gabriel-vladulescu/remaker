...
{
	public class RaidBossModeLogic : IBattleModeLogic
	{
		...
		private RaidBossConfig raidBossConfig;
		...
		private Action onBossHasDataCallback;

		public RaidTeamData TeamData => null;

		public RaidMonsterStatsLogic RaidMonsterStatsLogic => null;

		public MonsterData BossData => null;

		public RaidBossModeLogic(RaidBossConfig.Room roomInfo, RaidTeamData teamData, Metric metric)
		{
		}
		...
		public void SetOnBossHasDataCallback(Action callback)
		{
		}
	}
}
