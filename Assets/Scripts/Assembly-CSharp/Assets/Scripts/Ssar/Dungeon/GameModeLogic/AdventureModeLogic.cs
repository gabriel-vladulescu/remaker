...
{
	public class AdventureModeLogic : IBattleModeLogic
	{
		...
		private AdventureBattleInterfaceLogic interfaceLogic;

		private OnAdventureWinLogic adventureWinLogic;

		private OnAdventureLoseLogic adventureLoseLogic;

		private IEquippedEquipmentVisualInfo defaultEquippedEquipmentVisualInfo;

		private MainCharacterData mainCharacterData;

		public AdventureModeLogic(global::Scripts.Config.Dungeon dungeon)
		{
		}

		public AdventureModeLogic(global::Scripts.Config.Dungeon dungeon, MainCharacterData data)
		{
		}
