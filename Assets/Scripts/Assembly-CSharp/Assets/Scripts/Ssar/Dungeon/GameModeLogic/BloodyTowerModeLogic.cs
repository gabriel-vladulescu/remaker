...
{
	public class BloodyTowerModeLogic : IBattleModeLogic
	{
		...
		private BloodyTowerConfig bloodyTowerConfig;

		private OnBloodyTowerWinLogic _bloodyTowerWinLogic;

		private OnBloodyTowerLoseLogic OnBloodyTowerLoseLogic;

		private BloodyTowerEnvironmentAssetsPath bloodyTowerEnvironmentAssetsPath;

		private BloodyTowerModeBattleInterfaceLogic interfaceLogic;

		private DefaultEquippedEquipmentVisualInfo defaultEquippedEquipmentVisualInfo;

		public BloodyTowerModeLogic(BloodyTowerFloorInfo floorInfo, Metric metric, AchievementLogic al)
		{
		}
