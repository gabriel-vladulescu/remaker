...
namespace Assets.Scripts.Ssar.BloodyTower.Command
{
	public class ShowBloodyTowerPopupCmd : BaseShowPopupCmd
	{
		[CompilerGenerated]
		private sealed class _003CDelay_003Ed__5 : IEnumerator<object>, IEnumerator, IDisposable
		{
			...
			public ShowBloodyTowerPopupCmd _003C_003E4__this;
