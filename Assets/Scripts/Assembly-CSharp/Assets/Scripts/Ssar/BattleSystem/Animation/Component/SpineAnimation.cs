...
namespace Assets.Scripts.Ssar.BattleSystem.Animation.Component
{
	public class SpineAnimation : Assets.Scripts.Ssar.Combat.HeroStateMachines.Animation
	{
		...
		public SpineAnimation(SkeletonAnimation skeletonAnimation, RoutineRunner routineRunner, Dictionary<string, float> scaleTimeByAnimationName)
		{
		}

		private bool IsAnimationExisted(string animationName)
		{
			return false;
		}

		public void Listen(Action<string> onAnimationStart, Action<string> onAnimationEnd)
		{
		}
		...
		private void QueueAnimation(string name, bool loop)
		{
		}
