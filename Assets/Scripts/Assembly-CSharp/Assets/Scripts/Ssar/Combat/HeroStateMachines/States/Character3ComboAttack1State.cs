...
{
	public class Character3ComboAttack1State : State
	{
		...
		public Character3ComboAttack1State(UserInput userInput, Animation animation, Movement movement, Event event_, Hero hero, Character character, string skillId, ComboAttackState.IgnoreInputWindow iiw, ComboAttackState.AnimationFrame af)
		{
		}
