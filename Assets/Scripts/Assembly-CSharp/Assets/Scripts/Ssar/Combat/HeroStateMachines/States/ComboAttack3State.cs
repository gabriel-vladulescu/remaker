...
{
	public class ComboAttack3State : ComboAttackState
	{
		private Hero hero;
		...
		public ComboAttack3State(UserInput userInput, Animation animation, Movement movement, Event event_, Hero hero, Character character, string skillId, IgnoreInputWindow iiw, AnimationFrame af)
