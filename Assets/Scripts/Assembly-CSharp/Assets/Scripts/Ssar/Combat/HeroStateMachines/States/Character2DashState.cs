...
{
	public class Character2DashState : State
	{
		...
		public Character2DashState(UserInput userInput, Animation animation, Movement movement, Event event_, Hero hero, Character character, string skillId, ComboAttackState.AnimationFrame af, ComboAttackState.IgnoreInputWindow ignoreInputWindow)
		{
		}
