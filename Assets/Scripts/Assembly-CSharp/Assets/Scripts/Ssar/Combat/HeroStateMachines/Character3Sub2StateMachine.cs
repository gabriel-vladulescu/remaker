...
{
	public class Character3Sub2StateMachine : HeroStateMachine
	{
		...
		public Character3Sub2StateMachine(UserInput userInput, Animation animation, Movement movement, Event @event, Hero hero, Character character, EquippedSkills equippedSkills)
