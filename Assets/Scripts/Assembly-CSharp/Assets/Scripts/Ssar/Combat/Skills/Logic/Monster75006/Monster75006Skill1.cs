...
{
	public class Monster75006Skill1 : DefaultMeleeSkill
	{
		public class Info
		{
			public float spawnY;
			...
			public float vfxMinDistance;

			public float vfxMaxDistance;

			public float vfxMinOffsetY;

			public float vfxMaxOffsetY;
		}
		...
		private Dictionary<EventFrame, KeyValuePair<Vector2, int>> mappingVfxPositions;

		public Monster75006Skill1(Dependencies dependencies)
			: base(null)
		{
		}
		...
		private void SpawnTentacleVfx(Vector2 pos, int direction)
		{
		}
	}
}
