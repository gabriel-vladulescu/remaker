...
namespace Assets.Scripts.Core.Skills.Modifiers
{
	public class DodgeModifier : Modifier
	{
		...
		private DodgeShadow dodgeShadow;

		public DodgeModifier(Info info, Entity target)
		{
		}
		...
		private void InitShadow(GameObject targetGameObject)
		{
		}

		private void CopyDataFromBaseShadow()
		{
		}
	}
}
