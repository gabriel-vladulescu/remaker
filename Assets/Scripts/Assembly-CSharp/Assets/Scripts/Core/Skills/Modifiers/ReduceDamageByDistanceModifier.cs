...
{
	public class ReduceDamageByDistanceModifier : Modifier
	{
		public interface ReduceDamageByDistanceInfo
		{
			float Duration();
		...
		private ReduceDamageByDistanceInfo info;

		private float elapsed;

		public ReduceDamageByDistanceModifier(ReduceDamageByDistanceInfo info)
		{
		}
