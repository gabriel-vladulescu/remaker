...
{
	public class DarkArcaneModifier : Modifier
	{
		public class Info
		{
			...
			public Info(float duration, bool isLifeCycleDependOnParentSkill, float skillDurationExtensionPerKill)
			{
			}
		}
		...
		public DarkArcaneModifier(Info info)
		{
		}
