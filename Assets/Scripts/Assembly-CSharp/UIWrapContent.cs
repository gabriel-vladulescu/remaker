...
public class UIWrapContent : MonoBehaviour
{
	...
	protected LockUpdateItem lockUpdateItem;
	...
	/// <summary>
	/// Pivot-aware overload used by wrap content variants that need to know which edge an item wrapped past.
	/// </summary>
	...
	/// <summary>
	/// Pivot-aware check used by wrap content variants that need to know which edge an item wrapped past.
	/// </summary>
